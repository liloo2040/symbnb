...
class Ad
{
    ...
    /**
     * Permet d'obtenir un tableau des jours indisponibles pour l'annonce
     *
     * @return array Tableau d'objets DateTime des jours d'occupation
     */
